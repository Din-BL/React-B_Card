...
import { addressFormatter, capitalizeFirstLetter, inputData, websiteLink } from '../utils/helpers';
...
function Contact({ businessInfo }: ContactProps) {
    ...
    const contactItems = [
        ...
        { icon: <Language />, label: 'Website', value: businessInfo.web ? businessInfo.web : 'No link available', link: websiteLink(businessInfo.web) }
    ];
