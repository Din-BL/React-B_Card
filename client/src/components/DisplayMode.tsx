...
export default function DisplayMode() {
  ...
  const iconsMargin = () => (pathUrl('home', location) ? (isSmScreen ? 0 : 1) : 0);

  return (
    <ToggleButtonGroup size="large" sx={{marginRight: iconsMargin()}} value={view} exclusive onChange={handleView}>
