...
export const defaultCards: BusinessCard[] = [
  {
    ...
    zip: '12345',
    rating: 2,
    liked: {liked: false, disliked: false},
  ...
  },
  {
    ...
    description:
      "Rachel's Graphic Design offers creative and professional graphic design services. We specialize in logo design, branding, and marketing materials. Our goal is to help businesses stand out with visually appealing and impactful designs. Contact us today to discuss your design needs.",
    phone: '0549876543',
  ...
  },
  {
    ...
    subtitle: 'Baker',
    description:
      "Sophie's Bakery specializes in delicious homemade baked goods. From bread and pastries to cakes and cookies, our treats are made with love and quality ingredients. Order custom cakes for special occasions or drop by our bakery for a fresh selection. Indulge in the delightful flavors of Sophie's Bakery.",
    phone: '0523456789',
